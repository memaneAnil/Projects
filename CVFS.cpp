...
void man(char * name)
{
    ...
    {
        printf("Description : Used to display information of file\n");
        printf("Usages : fstat File_Descriptor\n");
    }
    ...
    {
        printf("Description : Used to changed file offset\n");
...
int CreateFile(char * name,int permission)
{
    ...
    UFDTArr[i].ptrfiletable = (PFILETABLE)malloc(sizeof(FILETABLE));///////check wheather to free(UFDTArr[i].ptrfiletable)
...
int rm_File(char * name)
{
    ...
    if(UFDTArr[fd].ptrfiletable->ptrinode->LinkCount == 0)
    {
        ...
        //free(UFDTArr[fd].ptrfiletable->ptrinode);/////////////////////////////////////////
...
int ReadFile(int fd,char *arr,int isize)
{
    ...
    if(UFDTArr[fd].ptrfiletable->ptrinode->FileType != REGULAR)
    {
       ...
       // printf("readoffset = %d",(UFDTArr[fd].ptrfiletable->readoffset));
    ...
    while(1)
    {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"write") == 0)
            {
                ...
                if(ret==0)
                {
                    printf("ERROR : Incorrect prarameter\n");
        ...
        else if(count == 3)
        {
            ...
            else if(strcmp(command[0],"open")==0)
            {
                ...
                if(ret >= 0)
                {
                    printf("File is successfully opened with file descriptot : %d\n",ret);
                }
                if(ret == -1)
                {
                    printf("ERROR : Incorrect parameters \n");
