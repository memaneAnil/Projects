...
class MarvellousLogin extends Template implements ActionListener,Runnable
{
    ...
    MarvellousLogin()
    {
        ...
        label2.setBounds(50,185,size.width,size.height);
        label2.setHorizontalAlignment(SwingConstants.CENTER);

        text2 = new JPasswordField(15);
        text2.setBounds(200,185,tsize.width,tsize.height);
        ...
        Dimension lsize = label3.getPreferredSize();

        label3.setForeground(Color.RED);
        label3.setBounds(50,135,lsize.width,lsize.height);
